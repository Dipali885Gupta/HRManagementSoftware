...
```
127.0.0.1 hrmanagementsoftware-local-web
127.0.0.1 hrmanagementsoftware-local-webgateway
127.0.0.1 hrmanagementsoftware-local-authserver
```
...
Now, you can browse the URL: `https://hrmanagementsoftware-local-web`
