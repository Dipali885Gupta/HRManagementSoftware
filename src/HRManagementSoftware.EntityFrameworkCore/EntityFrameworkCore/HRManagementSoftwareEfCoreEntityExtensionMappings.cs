...
public static class HRManagementSoftwareEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE HRManagementSoftwareModuleExtensionConfigurator CLASS (in the Domain.Shared project)
