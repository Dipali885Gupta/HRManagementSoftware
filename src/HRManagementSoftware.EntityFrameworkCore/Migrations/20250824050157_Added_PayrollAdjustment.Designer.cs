...
namespace HRManagementSoftware.Migrations
{
    ...
    [Migration("20250824050157_Added_PayrollAdjustment")]
    partial class Added_PayrollAdjustment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRManagementSoftware.HRManagers.HRManager", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppHRManagers", (string)null);
                });

            modelBuilder.Entity("HRManagementSoftware.LeaveRequests.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRManagementSoftware.PayrollAdjustments.PayrollAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPayrollAdjustments", (string)null);
                });
            ...
            modelBuilder.Entity("HRManagementSoftware.LeaveRequests.LeaveRequest", b =>
                {
                    b.HasOne("HRManagementSoftware.Employees.Employee", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HRManagementSoftware.PayrollAdjustments.PayrollAdjustment", b =>
                {
                    ...
                    b.HasOne("HRManagementSoftware.LeaveRequests.LeaveRequest", null)
                        .WithMany()
