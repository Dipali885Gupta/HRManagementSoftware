...
@Component({
  selector: 'app-hrmanager-detail-modal',
  ...
  templateUrl: './hrmanager-detail.component.html',
  styles: [],
})
export class HRManagerDetailModalComponent {
  public readonly service = inject(HRManagerDetailViewService);
}
