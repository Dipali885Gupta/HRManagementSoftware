import type { EmployeeCreateDto, EmployeeDto, EmployeeExcelDownloadDto, EmployeeUpdateDto, EmployeeWithNavigationPropertiesDto, GetEmployeesInput } from './models';
...
export class EmployeeService {
  ...
  deleteAll = (input: GetEmployeesInput, config?: Partial<Rest.Config>) =>
    this.restService.request<any, void>({
      ...
      params: { filterText: input.filterText, employeeNumber: input.employeeNumber, jobTitle: input.jobTitle, dateOfJoiningMin: input.dateOfJoiningMin, dateOfJoiningMax: input.dateOfJoiningMax, paidLeaveBalanceMin: input.paidLeaveBalanceMin, paidLeaveBalanceMax: input.paidLeaveBalanceMax, sickLeaveBalanceMin: input.sickLeaveBalanceMin, sickLeaveBalanceMax: input.sickLeaveBalanceMax, unpaidLeaveBalanceMin: input.unpaidLeaveBalanceMin, unpaidLeaveBalanceMax: input.unpaidLeaveBalanceMax, baseSalaryMin: input.baseSalaryMin, baseSalaryMax: input.baseSalaryMax, identityUserId: input.identityUserId, sorting: input.sorting, skipCount: input.skipCount, maxResultCount: input.maxResultCount },
    },
    { apiName: this.apiName,...config });
  ...
  getListAsExcelFile = (input: EmployeeExcelDownloadDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, Blob>({
      ...
      params: { downloadToken: input.downloadToken, filterText: input.filterText, employeeNumber: input.employeeNumber, jobTitle: input.jobTitle, dateOfJoiningMin: input.dateOfJoiningMin, dateOfJoiningMax: input.dateOfJoiningMax, paidLeaveBalanceMin: input.paidLeaveBalanceMin, paidLeaveBalanceMax: input.paidLeaveBalanceMax, sickLeaveBalanceMin: input.sickLeaveBalanceMin, sickLeaveBalanceMax: input.sickLeaveBalanceMax, unpaidLeaveBalanceMin: input.unpaidLeaveBalanceMin, unpaidLeaveBalanceMax: input.unpaidLeaveBalanceMax, baseSalaryMin: input.baseSalaryMin, baseSalaryMax: input.baseSalaryMax, identityUserId: input.identityUserId },
    },
    { apiName: this.apiName,...config });
  

  getNewEmployeeNumber = (config?: Partial<Rest.Config>) =>
    this.restService.request<any, EmployeeDto>({
      method: 'GET',
      url: '/api/app/employees/by-userid',
    },
    { apiName: this.apiName,...config });
